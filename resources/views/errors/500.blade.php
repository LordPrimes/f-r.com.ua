...
<div  class="scrolingtop btn btn-rounded btn-light-green  " ></div>
    <i class="fa fa-arrow-up fa-2x" ></i>
</div>
<main > 
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 erros-404"  style="background-image: url('{{ asset("img/404.jpg") }}'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
