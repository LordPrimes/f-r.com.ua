...
@section('page_header')
    ...
    <a href="{{route('voyager.'.$dataType->slug.'.editatribut', $dataTypeContent->getKey())}}" class="btn btn-dark">Добавить податрибут</a>
    </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    <div class="order-products">
                        <h3 style="margin-left: -15px;" class="panel-title">Список податрибутов:</h3>
            @foreach ($selecetfilters as $item)
            <div class="order-body">
                    <li>Податрибут: {{$item->name}}</li>
            </div>
            @endforeach
        </div>
